...
public class BlackjackGui {
     ...
     */
        ...
        public class GameWindow extends JFrame implements ActionListener {
                ...
                private PlayerPanel ai4;
                private PlayerPanel ai5;
        ...
        private boolean turnContinue;
            ...
            turnContinue = true;
                        ...
                        ai4 = new PlayerPanel("Computer 4", false, PlayerPanel.HARD, START_MONEY, MIN_BET, cardImages);
                        ai5 = new PlayerPanel("Computer 5", false, PlayerPanel.HARD, START_MONEY, MIN_BET, cardImages); 
                        players.add(human);
                        players.add(ai1);
                        players.add(ai2);
                        players.add(ai3);
